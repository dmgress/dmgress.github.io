...
date: 2013-09-30 17:02:18+00:00
meta:
  _edit_last: '6246633'
  _publicize_done_external: a:1:{s:7:"twitter";a:1:{i:89917968;b:1;}}
  _wpas_done_129558: '1'
  publicize_twitter_url: http://t.co/rMQArDqjR8
  publicize_twitter_user: 123579D
parent_id: '0'
password: ''
permalink: /2013/09/30/m101js-week-7/
published: true
status: publish
tags:
- m101js
...
When I finish this course I will have refreshed my MongoDB knowledge and got some experience with Node.js in the form of a blog application. I decided to document my progress in (at least) weekly summaries. This will be the last of seven. You can read part [six](http://gressie.wordpress.com/2013/09/23/m101js-week-6/ "M101JS Week 6") here.
...
Now that MongoDB was installed on Windows I wanted to run the exam assignments in Windows as well. Here I ran into another problem, for some reason I couldn't properly `npm install` on Windows. I got the errors:

```
... \Final3\node_modules\mongodb\node_modules\bson\build\bson.vcxproj(18,3): error MSB4019: The imported project "C:\Microsoft.Cpp.Default.props" was not found. Confirm that the path in the <Import> declaration is correct, and that the file exists on disk.
