...
date: 2013-09-16 19:21:01+00:00
meta:
  _edit_last: '6246633'
  _publicize_done_external: a:1:{s:7:"twitter";a:1:{i:89917968;b:1;}}
  _wpas_done_129558: '1'
  publicize_reach: a:2:{s:7:"twitter";a:1:{i:129558;i:22;}s:2:"wp";a:1:{i:0;i:1;}}
  publicize_twitter_user: 123579D
parent_id: '0'
password: ''
permalink: /2013/09/16/m101js-week-5/
published: true
status: publish
tags:
- m101js
...
When I finish this course I will have refreshed my MongoDB knowledge and got some experience with Node.js in the form of a blog application. I decided to document my progress in (at least) weekly summaries. This will be part five of seven. You can read part [four](http://gressie.wordpress.com/2013/09/08/m101js-week-4/ "M101JS Week 4") here.
...
I already was familiar of the way piping in unix environments is used as an analogy when explaining the [aggregation pipeline](http://docs.mongodb.org/manual/core/aggregation-pipeline/ "MongoDB Docs: Aggregation pipeline"). In order to use this pipeline you execute the `aggregate` command on a collection. It's parameter is an array of operations that is on all the data you can pull from that one collection. MongoDB has other aggregation commands, the [single purpose aggregation commands](http://docs.mongodb.org/manual/core/single-purpose-aggregation/ "MongoDB Docs: Single Purpose Aggregation Commands") and the [Map-Reduce command](http://docs.mongodb.org/manual/core/map-reduce/ "MongoDB Docs: Map-Reduce") but these weren't mentioned.
...
[code language="javascript"]<br />{'$unwind': '$scores'},<br />{'$match': { '$scores.type' : { '$ne' : 'quiz' } } }<br />[/code]
